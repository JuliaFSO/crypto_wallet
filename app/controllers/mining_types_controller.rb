class MiningTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mining_type.save
        format.html { redirect_to mining_type_url(@mining_type), notice: t('notice_mining_type.created') }
  ...
  def update
    respond_to do |format|
      if @mining_type.update(mining_type_params)
        format.html { redirect_to mining_type_url(@mining_type), notice: t('notice_mining_type.updated') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mining_types_url, notice: t('notice_mining_type.destroyed') }
